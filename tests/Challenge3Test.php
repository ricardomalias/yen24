...
//        $this->stateRepositoryMock = $this
//            ->getMockBuilder(AvailableStateRepositoryInterface::class)
//            ->setMethods(['all'])
//            ->disableOriginalConstructor()
//            ->getMock();

        $availableState = new AvailableState();
        $availableState->something($addressId);
...
//        $this->stateRepositoryMock->expects($this->any())->method('all')->willReturn([$allowedState]);
